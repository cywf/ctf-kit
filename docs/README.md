...
### Getting Started
- [CTF Overview](ctf-overview.md) - Introduction to Capture The Flag competitions
- [Contribution Guide](../CONTRIBUTING.md) - How to contribute to this repository

### CTF Formats
- [Jeopardy-Style CTF](jeopardy-style.md) - Most common CTF format with independent challenges
- [Attack-Defense CTF](attack-defense-ctf.md) - Team-based competitive format
- [King of the Hill CTF](king-of-the-hill-ctf.md) - Hybrid competitive format

### Challenge Types
- [Challenge Types Overview](challenges/README.md) - Summary of all challenge categories
- [Web Exploitation](challenges/web-exploitation.md) - Web application vulnerabilities
- [Cryptography](challenges/cryptography.md) - Breaking and manipulating cryptographic systems
- [Forensics](challenges/forensics.md) - Analyzing data and recovering information
- [Reverse Engineering](challenges/reverse-engineering.md) - Analyzing compiled software
- [Miscellaneous](challenges/miscellaneous.md) - Other challenge types

## Quick Links

### For Beginners
1. Start with [CTF Overview](ctf-overview.md) to understand what CTFs are
2. Choose your format: [Jeopardy-Style](jeopardy-style.md) is recommended for beginners
3. Learn about [Challenge Types](challenges/README.md)
4. Explore the [scripts directory](../scripts/README.md) for useful tools
...
- [CTFtime](https://ctftime.org/) - CTF calendar and team rankings
- [Hack The Box](https://www.hackthebox.eu/) - Online penetration testing labs
...
### Tool Documentation
Refer to the [scripts directory](../scripts/README.md) for documentation on available tools.
...
- Discuss in the community channels
